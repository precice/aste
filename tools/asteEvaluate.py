...
class Calculator:
    ...
    def create_logger(self):
        ...
        logger.setLevel(getattr(logging, self.args.logging))
        ch = logging.StreamHandler()
        ch.setLevel(getattr(logging, self.args.logging))
    ...
    def create_predeffunctions(self):
        ...
        self.preDefFunctions.update(self.preDef2DFunctions)
