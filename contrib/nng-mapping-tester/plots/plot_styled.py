...
def plotError(dfo):
    ...
    plt.grid()
    plt.savefig("turbine-error-best.pdf")
...
def plotMemory(dfo):
    ...
    plt.gca().invert_xaxis()
    plt.grid()
    plt.savefig("turbine-peakMemB.pdf")
...
def plotComputeMappingTime(dfo):
    ...
    plt.gca().invert_xaxis()
    plt.grid()
    plt.savefig("turbine-computed.pdf")
...
def plotMapDataTime(dfo):
    ...
    plt.gca().invert_xaxis()
    plt.grid()
    plt.savefig("turbine-mapped.pdf")
