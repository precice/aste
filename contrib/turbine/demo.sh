...
python3 ../../src/eval_mesh.py handMade.vtk -o coarseMeshWithData.vtk "y"

# Decompose both meshes to two procesors
python3 ../../src/partition_mesh.py coarseMeshWithData.vtk -n 2 > log.coarse
python3 ../../src/partition_mesh.py turbineFine.vtk -n 2 > log.fine
...
mpirun -n 2 ../../build/preciceMap -v -p B --mesh turbineFine --output mapped
